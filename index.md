...
*--LLM based on facebook/opt-1.3B model, fine-tuned using public fianancial data, and hosted online using Hugging Face Space, Hugging Face (transformers) & Python (torch).*
<img src="images/FinChat.png?raw=true"/>

---

[2. XGBoostRegressor (Azure AI | Machine Learning Studio)](https://ml.azure.com/experiments/id/7b645f8f-7256-4c1c-856a-9d0fcfde4056/runs/bike-rentals-3_0?wsid=/subscriptions/502460ab-9b04-4a78-bcdc-f66453f64081/resourcegroups/group_Alpha/providers/Microsoft.MachineLearningServices/workspaces/Azure_workspace&tid=4a4e828a-52ae-46d2-b126-3e75b1fb605a#metrics)
