...
[Predicting Bike Rentals - Time Series (via Python skforecast & statsmodels)](https://github.com/ANiraula/data_projects/blob/main/bike_rental_time_series_ARIMAX.py)

*--Time Sereis forecasting of Bike Share hourly data via Python (XGBRegressor, skforecast, sklearn, statsmodels). Visualizing seasonality and autocorrelation patterns,fitting XGBRegressor model with and without rolling 3-day average, picking best lags and hyperparameters to minimize Mean Absolute Error*
...
*--LLM based on Google's Gemma 3n model with more than 2B parameters, fine-tuned using PEFT method with stock price data and financial Q&A data, and hosted online using Hugging Face Spaces, Hugging Face (transformers) & Python (PyTorch, Sklearn etc).*
<img src="images/FinChat_emma-3n.png?raw=true"/>

---

[XGBoostRegressor (Azure AI Machine Learning Studio)]
...
[Multiple regression models - actuals vs. predicted (Python sklearn + Dash)](https://mlbikerides.onrender.com)
...
[Logistic regression ML (Python sklearn)](https://mlapp-diabetic.onrender.com)
...
[Pension Trends Linear Regression (w/ R Shiny)](https://reason.shinyapps.io/DistCoveredEE2/)
...
[Candy Data Logistic Regression (w/ R + Jupyter NoteBook)](https://github.com/ANiraula/data_projects/blob/main/candy/R-candy.ipynb)
...
[Seoul Bike Share Analysis (w/ R + R Markdown)](https://github.com/ANiraula/data_projects/tree/main/SeoulBikeShare)
...
[Data workflow (*Palantir Foundry*)]
...
[Pension Database (*App w/ PostgreSQL + R Shiny*)](https://anil-niraula.shinyapps.io/ReasonDataViewer4)
...
[Invesment Returns (*App w/ R Reactable + Shiny*)](https://reason.shinyapps.io/StatePublicPensionReturnResults2021/)
...
[Invesment Returns 2022 (*App w/ R + datawrapper*)](https://reason.shinyapps.io/StatePublicPensionReturnResults2021/)
...
[US Electricity Supply/Demand (*Viz w/ Python pandas*)](https://github.com/ANiraula/data_projects/blob/main/ElectricSupplyDemand_2020.py/)
...
[Compound Change in Debt (*App w/ Shiny + HTML + Netlify*)](https://reason.shinyapps.io/GainLoss_LASERS/)
...
[R Package (*w/ R + Roxygen2 + GitHub*)](https://github.com/ReasonFoundation/pensionviewr)
...
[PowerPoint Slides (w/ RMarkdown + "pensionviewr" R pkg)](http://example.com/)
...
[Pension Benefit Projection (*App w/ R + Shiny*)](https://anil-niraula.shinyapps.io/PensionBenefitModel_SCRS/)
...
[Pension Benefit Model (*Interactive Doc w/ RMarkdown + Shiny*)](https://anil-niraula.shinyapps.io/PensionWealthModeling/)
...
Pension Actuarial Model (*Interactive R Shiny*)
...
[New Normal in Investment Returns (w/ Excel & R)](https://reason.org/wp-content/uploads/new-normal-public-pension-investment-returns.pdf)

[Alaska TRS Employee Separation Effects (w/ R & Stata)](https://reason.org/wp-content/uploads/effects-transition-to-defined-contribution-retirement-plan-on-teacher-separations-in-alaska.pdf)
